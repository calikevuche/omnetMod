 ...
 * @ingroup macLayer
 */
class INET_API DevMac : public WirelessMacBase, public INotifiable
{
  ...
  protected:
    ...
    /** Protocol delay [0, 0.01, 0.02, 0.03, 0.04] sec  */
    double protocol_delay;
  ...
  protected:
    ...
    int sequenceNumber;
    int currentpacketSequenceNumber;
    int previouspacketSequenceNumber;
    int currentpacketSequenceNumber_2;
    int previouspacketSequenceNumber_2;
    int currentpacketSequenceNumber_3;
    int previouspacketSequenceNumber_3;
    int currentpacketSequenceNumber_4;
    int previouspacketSequenceNumber_4 ;
    int currentpacketSequenceNumber_5;
    int previouspacketSequenceNumber_5 ;
    int currentpacketSequenceNumber_6;
    int previouspacketSequenceNumber_6 ;
  ...
  protected:
    ...
    cMessage *ackTimeout; /* ACK has failed to comeback, so try again */

    cMessage *backoffTime;
  ...
  protected:
    ...
    int delay;
    simtime_t macdelay;
    simtime_t begin_time;
    simtime_t end_time;
    cOutVector stateVector;
    cOutVector radioStateVector;
    cOutVector endToEndDelayVec;
    double randvariableb;

    long numBitsN1;
    long numBitsN2;
    long numBitsRB;
    int total_packets;
    long iris_hardware_delay_ACK;

    //delay
    simtime_t total_delay;
    simtime_t iris_hardware_delay;
    //@}
  ...
  protected:
    ...
    virtual void sendDataFrame(Ieee80211DataOrMgmtFrame *frameToSend, bool delay);
...
//    virtual void retryCurrentTransmission();
   ...
   /** @brief Send down the change channel message to the physical layer if there is any. */
    ...
    virtual Ieee80211DataOrMgmtFrame *buildDataFrame(Ieee80211DataOrMgmtFrame *frameToSend);
    //virtual Ieee80211DataOrMgmtFrame *buildIMPACKDataFrame(Ieee80211DataOrMgmtFrame *frameToIMPACKSend);
